...
public class DateLogger_$logger_sv_SE extends DateLogger_$logger_sv implements DateLogger, BasicLogger, Serializable {
    ...
    private static final String logStringCouldntParseAsDate = "GTRDATES000003: giltigt datum skickas som sträng: %s.";
    @Override
    protected String logStringCouldntParseAsDate$str() {
        return logStringCouldntParseAsDate;
    }
    private static final String logDaysUntilRequest = "GTRDATES000004: Begärt antal dagar tills '%s'";
    @Override
